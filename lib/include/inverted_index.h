...
namespace inverted_index {
    ...
    struct docs {
        ...
        list_str links_docs; /**< List of documents the current document points to */
        ...
        /**
         * @brief Less-than operator for document comparison (used by containers like `set`).
         * @param other Another document to compare.
         * @return `true` if the current document is less than the other, based on the name.
         */
        bool operator<(const docs& other) const { return name_doc < other.name_doc; }
